    ...
    <form class="newsletter-form" data-endpoint="" novalidate>
      <div class="newsletter-field">
        ...
        <button class="newsletter-submit" type="submit" aria-label="Subscribe">
          ...
          <svg class="ns-state ns-eq" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect class="ns-eq-bar" x="2.5" y="10" width="2.2" height="4" rx="1.1"/><rect class="ns-eq-bar" x="6.7" y="6.5" width="2.2" height="11" rx="1.1"/><rect class="ns-eq-bar" x="10.9" y="3.5" width="2.2" height="17" rx="1.1"/><rect class="ns-eq-bar" x="15.1" y="6.5" width="2.2" height="11" rx="1.1"/><rect class="ns-eq-bar" x="19.3" y="10" width="2.2" height="4" rx="1.1"/></svg>
