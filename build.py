    ...
    <form class="newsletter-form" data-endpoint="" novalidate>
      <div class="newsletter-field">
        ...
        <button class="newsletter-submit" type="submit" aria-label="Subscribe">
          ...
          <svg class="ns-state ns-eq" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect class="ns-eq-bar" x="3.3" y="5.5" width="2.2" height="13" rx="1.1"/><rect class="ns-eq-bar" x="7.1" y="5.5" width="2.2" height="13" rx="1.1"/><rect class="ns-eq-bar" x="10.9" y="5.5" width="2.2" height="13" rx="1.1"/><rect class="ns-eq-bar" x="14.7" y="5.5" width="2.2" height="13" rx="1.1"/><rect class="ns-eq-bar" x="18.5" y="5.5" width="2.2" height="13" rx="1.1"/></svg>
