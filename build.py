    ...
    <form class="newsletter-form" data-endpoint="" novalidate>
      <div class="newsletter-field">
        ...
        <button class="newsletter-submit" type="submit" aria-label="Subscribe">
          ...
          <svg class="ns-state ns-eq" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect class="ns-eq-bar" x="2.5" y="3" width="2.2" height="18" rx="1.1"/><rect class="ns-eq-bar" x="6.7" y="3" width="2.2" height="18" rx="1.1"/><rect class="ns-eq-bar" x="10.9" y="3" width="2.2" height="18" rx="1.1"/><rect class="ns-eq-bar" x="15.1" y="3" width="2.2" height="18" rx="1.1"/><rect class="ns-eq-bar" x="19.3" y="3" width="2.2" height="18" rx="1.1"/></svg>
