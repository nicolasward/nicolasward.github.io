    ...
    <form class="newsletter-form" data-endpoint="" novalidate>
      <div class="newsletter-field">
        ...
        <button class="newsletter-submit" type="submit" aria-label="Subscribe">
          ...
          <svg class="ns-state ns-spinner" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path class="ns-spinner-path" pathLength="100" d="M5 12.5 A7.018 7.018 0 0 1 19 11.5 A7.018 7.018 0 0 1 5 12.5 L9.5 17 L19 7.5"/></svg>
        </button>
      </div>
