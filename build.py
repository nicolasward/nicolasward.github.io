    ...
    <form class="newsletter-form" data-endpoint="" novalidate>
      <div class="newsletter-field">
        ...
        <button class="newsletter-submit" type="submit" aria-label="Subscribe">
          ...
          <svg class="ns-state ns-eq" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect class="ns-eq-bar" x="1.4" y="10.5" width="1.6" height="3" rx="0.8"/><rect class="ns-eq-bar" x="3.85" y="8.75" width="1.6" height="6.5" rx="0.8"/><rect class="ns-eq-bar" x="6.3" y="6.75" width="1.6" height="10.5" rx="0.8"/><rect class="ns-eq-bar" x="8.75" y="5" width="1.6" height="14" rx="0.8"/><rect class="ns-eq-bar" x="11.2" y="3.5" width="1.6" height="17" rx="0.8"/><rect class="ns-eq-bar" x="13.65" y="5" width="1.6" height="14" rx="0.8"/><rect class="ns-eq-bar" x="16.1" y="6.75" width="1.6" height="10.5" rx="0.8"/><rect class="ns-eq-bar" x="18.55" y="8.75" width="1.6" height="6.5" rx="0.8"/><rect class="ns-eq-bar" x="21" y="10.5" width="1.6" height="3" rx="0.8"/></svg>
